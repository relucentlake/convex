...
from convex import Figure, Void, Point, Segment, Polygon, Triangle
...
class TestSegment:
    ...
    def setup_method(self):
        ...
        Figure.fixed_triangle = \
            Triangle(R2Point(0.0, 0.0), R2Point(2.0, 0.0), R2Point(1.0, 2.0))
    ...
    def test_g1(self):
        assert self.f.g() == approx(0.0)

    def test_g2(self):
        self.f = Segment(R2Point(0.0, 1.0), R2Point(2.0, 1.0))
...
class TestPolygon:
    ...
    def test_g1(self):
        t = Segment(R2Point(0.0, 1.0), R2Point(2.0, 1.0))
        t = t.add(R2Point(1.0, 3.0))
        assert t.g() == approx(1.0)

    def test_g2(self):
        t = Polygon(R2Point(0.0, 1.0), R2Point(2.0, 1.0), R2Point(1.0, 3.0))
        t = t.add(R2Point(4.0, 3.0))
        assert t.g() == approx(1.0)

    def test_g3(self):
        t = Polygon(R2Point(0.0, 0.0), R2Point(2.0, 0.0), R2Point(1.0, 2.0))
        assert t.g() == approx(0.0)